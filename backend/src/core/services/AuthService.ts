...
export class AuthService {
     ...
     */
    async register(username: string, password: string, role: string): Promise<{ user: User, token: string }> {
        try {
 ...
 */
    async authenticate(identifier: string, password: string): Promise<{ user: User, token: string, isFirstLogin?: boolean }> {
        try {
     ...
     */
    async generateProvisionalPassword(username: string): Promise<boolean> {
        try {
